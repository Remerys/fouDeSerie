 ...
 */
final class Version20221109081940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE serie CHANGE duree duree LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE serie CHANGE duree duree VARCHAR(11) DEFAULT NULL');
    }
}
